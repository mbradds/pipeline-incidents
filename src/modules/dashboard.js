...
export class EventMap {
  ...
  EVENTCOLORS = {
    ...
    companyColors: {
      "NOVA Gas Transmission Ltd.": pa.cerPalette["Night Sky"],
      "TransCanada PipeLines Limited": pa.cerPalette["Forest"],
      "Enbridge Pipelines Inc.": pa.cerPalette["Ocean"],
      "Enbridge Pipelines (NW) Inc.": pa.cerPalette["Cool Grey"],
      "Trans Mountain Pipeline ULC": pa.cerPalette["Flame"],
      "Trans Quebec and Maritimes Pipeline Inc.": pa.cerPalette["Sun"],
      "Trans-Northern Pipelines Inc.": pa.cerPalette["hcAqua"],
      "TransCanada Keystone Pipeline GP Ltd.": pa.cerPalette["hcBlue"],
      "Westcoast Energy Inc.": pa.cerPalette["hcRed"],
      "Alliance Pipeline Ltd.": pa.cerPalette["hcPurple"],
      "PKM Cochin ULC": pa.cerPalette["hcPink"],
      "Foothills Pipe Lines Ltd.": "#FF5733",
      "Emera Brunswick Pipeline Company Ltd.": "#9FFF33",
      "Trans-Northern Pipelines Inc.": "#FF3333",
      "Maritimes & Northeast Pipeline Management Ltd.": "#681F1F",
    },
    provinceColors: {
      ...
      "New Brunswick": pa.cerPalette["hcPurple"],
      "Nova Scotia": pa.cerPalette["hcRed"],
    },
    activityColors: {
      Operation: pa.cerPalette["Flame"],
      Construction: pa.cerPalette["Forest"],
      Maintenance: pa.cerPalette["Night Sky"],
      Abandonment: pa.cerPalette["Aubergine"],
    },
    discoveredColors: {
      "Employee / Contractor (Onsite)": pa.cerPalette["Night Sky"],
      Public: pa.cerPalette["Flame"],
      "Inspection Site Visit": pa.cerPalette["Forest"],
      Other: pa.cerPalette["Dim Grey"],
      SCADA: pa.cerPalette["Ocean"],
      "Scheduled Patrol": pa.cerPalette["Sun"],
      Landowner: pa.cerPalette["hcRed"],
      "3rd Party / Other Company": pa.cerPalette["Aubergine"],
    },
    whyColors: {
...
export class EventNavigator {
  ...
  pillName(name) {
    if (name == "Status") {
      ...
      ["How was it discovered", "Was NEB Staff Deployed"].includes(name)
    ) {
  ...
  makeBar(barName, div, status, bar = true, customHeight = undefined) {
    if (customHeight) {
      document.getElementById(div).style.height = `${customHeight}px`;
    } else {
